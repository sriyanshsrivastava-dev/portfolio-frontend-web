...
export default function HeroVisual() {
    return (
        <div className="relative h-[400px] w-[300px] md:h-[600px] md:w-[500px]">
            ...
            <div className={"hidden md:block w-8 h-12 absolute -right-18 bottom-12 bg-radial from-blue-300/60 from-50% to-transparent to-50% bg-[size:10px_10px] bg-repeat"}></div>
            <div className={"hidden md:block w-12 h-18 absolute -left-22 top-24 bg-radial from-blue-400/50 from-50% to-transparent to-50% bg-[size:12px_12px] bg-repeat"}></div>
        </div>
    );
}